...
//     { '.', '.', 'X'}
// };
// Console.WriteLine("Output of stateWin: ");
// TicTacToe.OutputState(stateWin);
...
//          { 'X', 'O', 'X'}
//      };
// Console.WriteLine("Output of stateDraw: ");
// TicTacToe.OutputState(stateDraw);
...
//     { '.', '.', '.'}
// };
// Console.WriteLine("Output of stateXturn: ");
// TicTacToe.OutputState(stateXturn);
...
//          { '.', '.', 'O'}
//      };
// Console.WriteLine("Output of stateInvalid: ");
// TicTacToe.OutputState(stateInvalid);
